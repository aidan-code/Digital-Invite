...
function GetEvent() {
  return (
    <div className="thediv">
      ...
      <div class="mapouter">
        <div class="gmap_canvas"><iframe className='dmap' id="gmap_canvas" title="event" src="https://maps.google.com/maps?q=Whitestone%20Place%20Event%20Centre%203%20Billings%20Way,%20Oregun%20101233,%20Ikeja,%20Lagos%20Nigeria&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
      </div>
      </div>
